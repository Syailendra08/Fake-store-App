...
export default function CardCommerce() {
 ...
 <Card
      ...
      imgSrc="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSG8Os7WW10a9ZkgSXQ6mB02jNnDxwttLV5hw&s"
    >
      <a href="#">
      ...
      <div className="flex items-center justify-between">
        <span className="text-3xl font-bold text-gray-900 dark:text-white">Rp 500</span>
        <a
          href="#"
